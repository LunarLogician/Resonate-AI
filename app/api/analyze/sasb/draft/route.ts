...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = `
You are an ESG disclosure expert helping companies meet SASB requirements.

Given a SASB disclosure expectation (e.g. "Describe how the company manages data privacy risks") and the content of a draft ESG report, generate a short paragraph that could be included in the company’s report to better align with that requirement.

Use a professional, objective, and report-style tone. The draft should sound like part of an actual disclosure and should be grounded in the uploaded report.
...
{ "draft": "..." }
    ...
    console.error("SASB draft generation error:", err);
