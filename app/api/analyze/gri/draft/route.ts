...
export async function POST(req: Request) {
  try {
    ...
    const systemPrompt = `
You are a sustainability reporting expert specializing in GRI Standards.

Given a specific GRI requirement (e.g. "Describe the organization’s approach to stakeholder engagement") and the content of a draft ESG report, generate a short paragraph that could be included in the company’s report to better meet that requirement.
...
{ "draft": "..." }
    ...
    console.error("GRI draft generation error:", err);
